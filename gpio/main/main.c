...
// Outputs with interrupt.  ??
#define GPIO9_OUTPUT_INT_PIN    (9)
#define GPIO8_OUTPUT_INT_PIN    (8)
#define GPIO8_9_MASK_BIT        ( (1<<GPIO9_OUTPUT_INT_PIN) | (1<<GPIO8_OUTPUT_INT_PIN))
...
static const gpio_config_t gpios_config_list[4] = 
{   
    // Outputs without interrupt.
    {
